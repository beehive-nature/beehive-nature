var BDIDKEY = (() => {
  ...
  __export(bdid_key_exports, {
    ...
    PRF_INPUT_SALT: () => PRF_INPUT_SALT,
    RECOVERY_HRP: () => RECOVERY_HRP,
    REC_VERSION: () => REC_VERSION,
    WORDS_DECISION: () => WORDS_DECISION,
    contextTag: () => contextTag,
    decodeRecoveryAuto: () => decodeRecoveryAuto,
    ...
    getPrfSecret: () => getPrfSecret,
    identityFromPasskey: () => identityFromPasskey,
    identityFromRecovery: () => identityFromRecovery,
    masterPrkFromPrfSecret: () => masterPrkFromPrfSecret,
    personaNullifier: () => personaNullifier,
    prfBrowserSupport: () => prfBrowserSupport,
    toHex: () => toHex,
    verifyRecordSig: () => verifyRecordSig
  });
  ...
  var ed25519_CURVE_p = /* @__PURE__ */ BigInt("0x7fffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffed"/*PUBLIC-CONSTANT*/)/*PUBLIC-CONSTANT*/;
  var ed25519_CURVE = /* @__PURE__ */ (() => ({
    p: ed25519_CURVE_p,
    n: BigInt("0x1000000000000000000000000000000014def9dea2f79cd65812631a5cf5d3ed"/*PUBLIC-CONSTANT*/)/*PUBLIC-CONSTANT*/,
    h: _8n3,
    a: BigInt("0x7fffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffec"/*PUBLIC-CONSTANT*/)/*PUBLIC-CONSTANT*/,
    d: BigInt("0x52036cee2b6ffe738cc740797779e89800700a4d4141d8ab75eb4dca135978a3"/*PUBLIC-CONSTANT*/)/*PUBLIC-CONSTANT*/,
    Gx: BigInt("0x216936d3cd6e53fec0a4e231fdd6dc5c692cc7609525a7b2c9562d608f25d51a"/*PUBLIC-CONSTANT*/),
    Gy: BigInt("0x6666666666666666666666666666666666666666666666666666666666666658/*PUBLIC-CONSTANT*/"/*PUBLIC-CONSTANT*/)
  }))();
  ...
  var ED25519_SQRT_M1 = /* @__PURE__ */ BigInt("19681161376707505956807079304988542015446066515923890162744021073123829784752/*PUBLIC-CONSTANT*/");
...
zoo`.split("\n"));
  ...
  var REC_VERSION = 1;
  var CONTEXT_TAG_LEN = 8;
  var WORDS_DECISION = 24;
  var te = new TextEncoder();
  var ascii = (s) => te.encode(s);
  ...
  var L = 0x1000000000000000000000000000000014def9dea2f79cd65812631a5cf5d3edn/*PUBLIC-CONSTANT*/;
  ...
  function deriveIdentity(masterPrk, context) {
  ...
  var randomBytes3 = (n) => crypto.getRandomValues(new Uint8Array(n));
  var bs = (u) => {
    const ab = new ArrayBuffer(u.length);
    new Uint8Array(ab).set(u);
    return ab;
  };
  async function prfBrowserSupport() {
    const PKC = typeof PublicKeyCredential !== "undefined" ? PublicKeyCredential : void 0;
    if (!PKC?.getClientCapabilities) return void 0;
    try {
  ...
  async function enrollPasskey(displayName, rpName = "BNR") {
    const cred = await navigator.credentials.create({
      publicKey: {
        rp: { name: rpName },
        user: { id: bs(randomBytes3(16)), name: displayName || "you", displayName: displayName || "you" },
        challenge: bs(randomBytes3(32)),
  ...
  function identityFromRecovery(input, context) {
