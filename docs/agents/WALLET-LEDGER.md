...
**zCode native testnet account (2026-09-08):** `bzcodejungle` created on Jungle4 (the `bcodexjungle` twin, founder-approved name), separate owner/active keys under Windows CurrentUser-DPAPI encryption outside the repo, verified through CryptoLions and Greymass; faucet-funded 100 A/EOS/JUNGLE by the founder. [Account receipt and setup status](../dispatches/RECEIPT_ZCODE_JUNGLE_ACCOUNT_2026-09-08.md).
