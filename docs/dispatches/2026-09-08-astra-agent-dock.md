...
The existing hub generator and generated page request dock version 8 together. No new surface, dependency, remote agent endpoint, storage migration or production-box change is introduced.
