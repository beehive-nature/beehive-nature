...
> Historical revision, superseded by the r2–r4 dispatches and the current
> `docs/runbooks/autonomi-fence-readiness.md`. In particular, the field-request
> closure and participation conclusions below were retracted; do not use them
> as current readiness or operational instructions.
