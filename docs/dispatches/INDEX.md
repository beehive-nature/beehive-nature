...
| `SURFACED_SPEND_RECEIPT_PRIVACY_2026-08-08.md` | Seat 0 | Options surface | Cowork | **AWAITING FOUNDER RULING.** Reframing: rails already publish the spends — the decision is concealing **linkage**, not spends. 5 options, none recommended. Schema is posture-agnostic; default-private is relaxable later, default-public is not retractable | committed |
