...
Canonical copy for the integrator path: [`festival-pilot-brief.md`](festival-pilot-brief.md). This alias keeps the same discovery order so older board links do not skip to tables.
