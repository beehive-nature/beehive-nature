...
The M6 working set (vk + one valid proof + one forged proof + the oracle
...
/tmp/test_plonk fixtures/proof.hex fixtures/pubs.hex fixtures/oraclescalars.txt   # 25/25
...
Provenance: produced by the M6 lane (RECEIPT-SOUNDNESS-M6.md); the
