...
export const JODOIN_PROVENANCE = "constant-weight baseline (7/16,3/16,3/16)/13 pending the paper's verified table — see hexdither.ts header";
/** 128 triples [wForward(d10), wBelow1(d-11), wBelow2(d01)], each summing to 1. */
export const JODOIN_TRIPLES = buildUniformTriples(7 / 13, 3 / 13, 3 / 13);
function buildUniformTriples(wf, wm, wo) {
