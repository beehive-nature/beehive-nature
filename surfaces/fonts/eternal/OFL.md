# Fonts of the three registers — licences

Taken byte-for-byte from the founder's blueprint `UI_Design_version_eternal.html` (2026-09-26), which embedded Google Fonts' woff2 subsets. Unmodified. Each is licensed under the SIL Open Font License 1.1; the full text follows once per family, as each project ships it.
