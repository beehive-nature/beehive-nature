...
const KEYS = process.env.TEST_KEYS;
const UPSTREAM_HOST = '127.0.0.1';
const UPSTREAM_PORT = process.env.UP_PORT;          // llama-server, bridge-internal
const UPSTREAM_KEY = process.env.LLAMA_KEY || fs.readFileSync('/opt/buzz-meter/upstream.key', 'utf8').trim();
const ACCESS_LOG = process.env.TEST_LOG;
...
server.listen(8095, '127.0.0.1', () => console.log('gate: listening on 172.18.0.1:8091 (LLAMA_KEY ' + (process.env.LLAMA_KEY ? 'from env' : 'from /etc/buzz-compute/api.key') + ')'));
