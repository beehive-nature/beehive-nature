...
//!    most cases.
//!
//! VENDORED CUT (z3.1, 2026-09-05): upstream also carries `embedding`
//! (ONNX model) and `hybrid` scorers plus a `create_scorer` factory.
//! They are NOT vendored — the offline cut keeps only the zero-model
//! BM25 rung TextCrusher actually calls. See lib.rs for the fence.
//!
